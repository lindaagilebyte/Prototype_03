...
export const VERSION = '2025-12-18-v001';
...
export const namePool = [
  ...
  "郭玄同", "林守拙", "鄭沖和", "杜玄度", "宋清源", "方養正",
  "彭虛白", "魏守中", "韓玄默", "謝沖虛", "唐養元", "袁靜一",

  "許抱真", "葉清修", "鍾守玄", "盧元靜", "蔡虛和", "羅養德",
  "顧清寧", "嚴守樸", "施玄養", "洪沖明", "金太一", "程靜元",

  "高守真", "范玄和", "姚養虛", "邱清一", "蘇抱和", "石守元",
  "秦玄清"
];
